...
@doc Markdown.doc"""
    FlintFiniteField(char::IntegerUnion, deg::Int, s::AbstractString; cached = true)
...
"""
function FlintFiniteField(char::IntegerUnion, deg::Int, s::AbstractString; cached = true)
   char = fmpz(char)
   S = Symbol(s)
