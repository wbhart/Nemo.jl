...
mutable struct FmpzModMatSpace <: MatSpace{Generic.Res{fmpz}}
  base_ring::Generic.ResRing{fmpz}
  n::fmpz
  rows::Int
  cols::Int

  function FmpzModMatSpace(R::Generic.ResRing{fmpz}, r::Int, c::Int,
                        cached::Bool = true)
    (r < 0 || c < 0) && throw(error_dim_negative)
    if haskey(FmpzModMatID, (R, r, c))
      return FmpzModMatID[R, r, c]
    else
      z = new(R, R.modulus, r, c)
      if cached
...
mutable struct fmpz_mod_mat <: MatElem{Generic.ResRing{fmpz}}
  ...
  function fmpz_mod_mat(r::Int, c::Int, n::fmpz)
    z = new()
    ccall((:fmpz_mod_mat_init, :libflint), Void,
  ...
  function fmpz_mod_mat(r::Int, c::Int, n::fmpz, arr::Array{fmpz, 1}, transpose::Bool = false)
    z = new()
    ccall((:fmpz_mod_mat_init, :libflint), Void,
          (Ref{fmpz_mod_mat}, Int, Int, Ref{fmpz}), z, r, c, n)
    finalizer(z, _fmpz_mod_mat_clear_fn)
  ...
  function fmpz_mod_mat(r::Int, c::Int, n::fmpz, arr::Array{T, 2}, transpose::Bool = false) where {T <: Integer}
    arr_fmpz = map(fmpz, arr)
    return fmpz_mod_mat(r, c, n, arr_fmpz, transpose)
  end

  function fmpz_mod_mat(r::Int, c::Int, n::fmpz, arr::Array{T, 1}, transpose::Bool = false) where {T <: Integer}
    arr_fmpz = map(fmpz, arr)
    return fmpz_mod_mat(r, c, n, arr_fmpz, transpose)
  end

  function fmpz_mod_mat(r::Int, c::Int, n::fmpz, arr::Array{nmod, 2}, transpose::Bool = false)
    z = new()
    ccall((:fmpz_mod_mat_init, :libflint), Void,
          (Ref{fmpz_mod_mat}, Int, Int, Ref{fmpz}), z, r, c, n)
    finalizer(z, _fmpz_mod_mat_clear_fn)
  ...
  function fmpz_mod_mat(r::Int, c::Int, n::fmpz, arr::Array{nmod, 1}, transpose::Bool = false)
    z = new()
    ccall((:fmpz_mod_mat_init, :libflint), Void,
          (Ref{fmpz_mod_mat}, Int, Int, Ref{fmpz}), z, r, c, n)
    finalizer(z, _fmpz_mod_mat_clear_fn)
  ...
  function fmpz_mod_mat(n::fmpz, b::fmpz_mat)
    z = new()
    ccall((:fmpz_mod_mat_init, :libflint), Void,
          (Ref{fmpz_mod_mat}, Int, Int, Ref{fmpz}), z, b.r, b.c, n)
    finalizer(z, _fmpz_mod_mat_clear_fn)
    ccall((:fmpz_mat_get_nmod_mat, :libflint), Void,
            (Ref{nmod_mat}, Ref{fmpz_mat}), z, b)
    return z
  ...
  function nmod_mat(n::T, b::fmpz_mat) where {T <: Integer}
    (n < 0) && error("Modulus must be positive")
    return nmod_mat(fmpz(n), b)
  end
